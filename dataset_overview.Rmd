---
title: "Lineage reconstruction dataset overview"
author: "Qin Zhu"
date: "11/17/2020"
...
You can first compute average expression of each lineage using the `cur_eset@assayData$norm_exprs` and `pData(cur_eset)$lineage`, then try to reconstruct the lineage tree using the average expression.

If you think average expression is not a good statistic to represent each lineage, you can come up with your own statistic, or directly build the tree with the single cell data.
